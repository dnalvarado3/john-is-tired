def on_up_pressed():
    ...
    zzz = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    zzz.set_position(76, 68)
    for index in range(10):
        zzz.x += 1
        zzz.y += -1
        pause(100)
    for index2 in range(4):
        zzz = sprites.create_projectile_from_sprite(img("""
                . . . . . . . . . . . . . . . . 
                            . . . . . . . . . . . . . . . . 
                            . . . . . . . . . . . . . . . . 
                            . . . . . . 8 8 8 8 . . . . . . 
...
def on_b_pressed():
    global number, zzz, tv
    game.show_long_text("choose a number 1-10 to decide if john should sleep or watch tv",
        DialogLayout.BOTTOM)
    number = game.ask_for_number("", 2)
    john.set_position(73, 80)
    if number >= 3:
        zzz = sprites.create(img("""
                . . . . . . . . . . . . . . . . 
                            . . . . . . . . . . . . . . . . 
        ...
        tv = sprites.create(img("""
            ...
            """),
            SpriteKind.player)
        tv.set_position(50, 80)
        john.say_text("i am really tired")
...
john = sprites.create(img("""
    ...
    SpriteKind.player)
john.set_position(73, 80)
game.show_long_text("John is tired", DialogLayout.BOTTOM)
game.show_long_text("should john go to sleep if yes press up if no press A then B?",
    DialogLayout.BOTTOM)